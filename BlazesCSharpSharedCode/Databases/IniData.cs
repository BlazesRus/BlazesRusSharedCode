...
namespace CSharpSharedCode.Databases
{
	/// <summary>
	...
	/// <summary>
	/// Class IniData.
	/// Implements the <see cref="System.Collections.Generic.List{CSharpSharedCode.Databases.IniDataElement}" />
	/// </summary>
	/// <seealso cref="System.Collections.Generic.List{CSharpSharedCode.Databases.IniDataElement}" />
	public class IniData : List<IniDataElement>
    {
        ...
        {
            List<string> FileData = CSharpSharedCode.GlobalMiscCode.FileAccessCommands.ReturnFileContentsAsList(FileName);
            string LineData;
            string IniSetting = "";
