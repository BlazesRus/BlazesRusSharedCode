...
namespace CSharpSharedCode.VariableLists
{
	...
	/// Implements the <see cref="System.Collections.Generic.List{CSharpSharedCode.VariableLists.QuadVector}" />
	/// </summary>
	/// <seealso cref="System.Collections.Generic.List{CSharpSharedCode.VariableLists.QuadVector}" />
