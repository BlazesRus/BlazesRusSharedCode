...
namespace CSharpSharedCode.ExperimentalCode
{
    ...
    MediumDec : IFormattable, INotifyPropertyChanged, IComparable<MediumDec>, IConvertible, IEquatable<MediumDec>
    {
        ...
        public MediumDec(dynamic Value)
        {
            ...
            {
                //Use to detect different assembly versions of MediumDec class
                Type ValueType = (Value as object).GetType();
                string ValueTypeName = ValueType.FullName;
                if (ValueTypeName == "CSharpSharedCode.ExperimentalCode.MediumDec" || ValueType == typeof(MediumDec))
                {
...
#pragma warning restore EA002 // Swallow exceptions considered harmful
        ...
        public override bool Equals(object value)
        {
            ...
            try
            {
                ...
                if (FullValueTypeName == "CSharpSharedCode.ExperimentalCode.MediumDec")//MediumDec to MediumDec Comparison
                {
        ...
        public int CompareTo(object value)
        {
            ...
            switch (FullValueTypeName)
            {
                ...
                default:
                    {
                        if (FullValueTypeName == "CSharpSharedCode.ExperimentalCode.MediumDec")//MediumDec comparisons
                        {
...
#endif
            //else if (FullValueTypeName == "CSharpSharedCode.ExperimentalCode.MediumDec")//MediumDec conversion
            //{
