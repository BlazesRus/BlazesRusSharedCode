...
public:
	...
	// Returns the length of this string.(Alias for returning size of vector)
	//************************************
	// Method:    length
	...
	*/
	...
	bool RemoveWithCheck(int index)
	{
		int TempInt;
		TempInt = Size();
	...
	void AddElementToIndex(int index, VariableType ElementValue)
	{
		this->emplace(this->begin() + index, ElementValue);
	}
	//	Add ElementValue at position:index in vector
	void Add(int index, VariableType TempValue)
	{
		AddElementToIndex(index, ElementValue);
	}
	/**Assign ElementValue at index in vector*/
	void SetElementAt(int index, VariableType ElementValue)
	{
	...
	// Parameter: int index
	//************************************
	VariableType RetrieveElementAtIndex(int index)
	{
	...
	int ReturnNewVariableIndex(VariableList TargetVariableList, int TargetIndex)
	{
		int index = -1;
	...
	{
		int TempInt = TargetVariableList.Size();
	...
	// Parameter: int index
	//************************************
	std::shared_ptr<VariableType> GetElementSharedPointer(int index)
	{
	...
	// Parameter: int index
	//************************************
	VariableType* GetElementPointer(int index)
	{
		if(index < Size())
		{
			VariableType* ArrayPointer = myvector.data();
	...
	// Parameter: int index
	//************************************
	VariableType* GetElementPointerV2(int index)
	{
		if(index < Size())
		{
