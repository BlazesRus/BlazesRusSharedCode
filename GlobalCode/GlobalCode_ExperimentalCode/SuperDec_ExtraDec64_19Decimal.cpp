#include "SuperDec_ExtraDec64_19Decimal.h"
...
#define SuperDec_sInt64 true
#define SuperDec_19Decimal true
#define SuperDec_EnableSpecialDecimalStatus true
#define SuperDec_UnsignedBoolean true

//void SuperDec_ExtraDec64_19Decimal::ConvertFromDecRep(signed __int64 Value)
//{
...
//}
//
//void SuperDec_ExtraDec64_19Decimal::ConvertFromDecRep(unsigned __int64 Value)
//{
//#if !defined SuperDec_AngleDecimal && defined SuperDec_SignedIntStatus
//	IntValue = Value / 1000000000;
//	DecimalStatus = Value - IntValue;
...
int SuperDec_ExtraDec64_19Decimal::AsInt32()
{
	try
	{
	...
	catch (std::overflow_error* e)//if value overflows return as max value instead
	{
		if(DecBoolStatus == 1) { return -2147483648; }
...
signed _int64 SuperDec_ExtraDec64_19Decimal::AsSignedInt64()
{
	if(DecBoolStatus==1){return IntValue*-1;}
	else { return IntValue; }
}

double SuperDec_ExtraDec64_19Decimal::AsDouble()
{
...
std::string SuperDec_ExtraDec64_19Decimal::AsString()
{
//#if defined SuperDec_SignedIntStatus
...
SuperDec_ExtraDec64_19Decimal SuperDec_ExtraDec64_19Decimal::operator+(std::string Value)
{
	if(Value == "PI")
	{
...
SuperDec_ExtraDec64_19Decimal SuperDec_ExtraDec64_19Decimal::operator+(double Value)
{
...
SuperDec_ExtraDec64_19Decimal SuperDec_ExtraDec64_19Decimal::operator^(unsigned int Value)
{
	unsigned __int64 TempValue = IntValue;
	if(Value == 0)
	{
		IntValue = 1;
		DecimalStatus = 0;
...
//unsigned __int64 SuperDec_ExtraDec64_19Decimal::DecAsUnsignedInt()
//{
