#include "SuperDec_ExtraDec32_19Decimal.h"
...
//}
//
//void SuperDec_ExtraDec32_19Decimal::ConvertFromDecRep(unsigned __int64 Value)
//{
//#if !defined SuperDec_AngleDecimal && defined SuperDec_SignedIntStatus
//	IntValue = Value / 1000000000;
//	DecimalStatus = Value - IntValue;
...
int SuperDec_ExtraDec32_19Decimal::AsInt32()
{
		if(DecBoolStatus == 1) { return IntValue*-1; }
		else { return IntValue; }
}

signed _int64 SuperDec_ExtraDec32_19Decimal::AsSignedInt64()
{
	if(DecBoolStatus==1){return IntValue*-1;}
	else { return IntValue; }
}

double SuperDec_ExtraDec32_19Decimal::AsDouble()
{
...
std::string SuperDec_ExtraDec32_19Decimal::AsString()
{
//#if defined SuperDec_SignedIntStatus
...
SuperDec_ExtraDec32_19Decimal SuperDec_ExtraDec32_19Decimal::operator+(std::string Value)
{
	if(Value == "PI")
	{
...
SuperDec_ExtraDec32_19Decimal SuperDec_ExtraDec32_19Decimal::operator+(double Value)
{
...
SuperDec_ExtraDec32_19Decimal SuperDec_ExtraDec32_19Decimal::operator^(unsigned int Value)
{
...
//unsigned __int64 SuperDec_ExtraDec32_19Decimal::DecAsUnsignedInt()
//{
