...
// ***********************************************************************
#if !defined(MediumDec_IncludeGuard) && !defined(ExcludeAltNum)
...
public:
    ...
    /// <param name="decVal">The decimal value.</param>
    ...
    /// <summary>
    /// Finalizes an instance of the <see cref="MediumDec"/> class.
    /// </summary>
    ~MediumDec() {}
private:
    /// <summary>
    /// The negative whole number
    /// </summary>
...
#pragma region ValueDefines
    ...
    static MediumDec MinimumValue()
    {
        ...
        return MediumDec((std::numeric_limits<unsigned int>::max)(), -999999999);
    }
...
#pragma region From this type to Standard types
    ...
    /// <summary>
    /// MediumDec to unsigned int explicit conversion
    /// </summary>
    /// <returns>The result of the operator.</returns>
    ...
    /// <summary>
    /// Implements the operator bool operator.
    /// </summary>
    /// <returns>The result of the operator.</returns>
...
#pragma region OperationTemplate
    /// <summary>
    /// Applies the unsigned int addition.
    /// </summary>
    ...
    /// <summary>
    /// Applies the unsigned int subtraction.
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="Value">The value.</param>
    /// <returns>MediumDec &.</returns>
    ...
    /// <summary>
    /// Applies the int multiplication.
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="Value">The value.</param>
    /// <returns>MediumDec &.</returns>
    ...
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="NumOfTimes">The number of times.</param>
    /// <returns>MediumDec &.</returns>
    template <typename ValueType>
    ...
    /// <summary>
    /// Equal to comparison operator integer function
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="Value">The value.</param>
    /// <returns>bool.</returns>
    ...
    /// <summary>
    /// Not equal to comparison operator integer function
    /// </summary>
    /// <param name="self">The self.</param>
    /// <param name="Value">The value.</param>
    /// <returns>bool.</returns>
...
#pragma region OtherFormulas
    ...
    class Coords
    {
        ...
        MediumDec PosZ;
        /// <summary>
        /// Prevents a default instance of the <see cref="Coords"/> class from being created.
        /// </summary>
        Coords()
        {
            PosX = MediumDec::Zero;
    ...
    class XZAngle
    {
        ...
        MediumDec AngleZ;
        /// <summary>
        /// Initializes a new instance of the <see cref="XZAngle"/> class.
        /// </summary>
        /// <param name="TempAngleX">The temporary angle x.</param>
        /// <param name="TempAngleZ">The temporary angle z.</param>
        XZAngle(MediumDec TempAngleX, MediumDec TempAngleZ) { AngleX = TempAngleX; AngleZ = TempAngleZ; }
        /// <summary>
        /// Prevents a default instance of the <see cref="XZAngle"/> class from being created.
        /// </summary>
    ...
    /// <param name="self">The self.</param>
    /// <param name="target">The target.</param>
    /// <param name="TargetHeightOffset">The target height offset.</param>
    /// <returns>MediumDecCode.XZAngle.</returns>
