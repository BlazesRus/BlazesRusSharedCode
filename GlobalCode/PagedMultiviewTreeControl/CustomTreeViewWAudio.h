...
class CustomTreeViewWAudio : public CView
{
	CRuntime_Arg03V2(CustomTreeViewWAudio, TreeNode, ContextMenuType, DocViewType, CView)
public:
...
public:
	...
	template <typename TreeType=CustomTreeViewWAudio>
...
CRuntimeImplimentation_Arg03(CustomTreeViewWAudio, TreeNode, ContextMenuType, DocViewType)
