...
#define _RUNTIME_CLASS01(class_name, template_class) ((CRuntimeClass*)(&class_name<template_class>::class##class_name##template_class))
#define RUNTIME_CLASS01(class_name, template_class) _RUNTIME_CLASS01(class_name, template_class)

#ifdef _AFXDLL
#define DECLARE_DYNAMIC01(class_name, template_class) \
protected: \
	static CRuntimeClass* PASCAL _GetBaseClass(); \
public: \
	static const CRuntimeClass class##class_name##template_class; \
	static CRuntimeClass* PASCAL GetThisClass(); \
	virtual CRuntimeClass* GetRuntimeClass() const; \

#define _DECLARE_DYNAMIC01(class_name, template_class) \
protected: \
	static CRuntimeClass* PASCAL _GetBaseClass(); \
public: \
	static CRuntimeClass class##class_name##template_class; \
	static CRuntimeClass* PASCAL GetThisClass(); \
	virtual CRuntimeClass* GetRuntimeClass() const; \

//DECLARE_DYNAMIC01+IMPLEMENT_DYNCREATE01+IMPLEMENT_RUNTIMECLASS01 (For placing inside template header file)
#define DECLAREFULL_DYNAMIC01(class_name, template_class, base_class_name) \
protected: \
...
#define DECLARE_DYNAMIC_COMDAT(class_name, template_class, base_class_name) \
	extern const AFX_COMDAT CRuntimeClass class##class_name##template_class = { \
	#class_name, sizeof(class class_name<template_class>), 0xFFFF, class_name<template_class>::CreateObject, \
...
#define _IMPLEMENT_RUNTIMECLASS01( class_name, template_class, base_class_name, wSchema, pfnNew, class_init ) \
    ...
    AFX_COMDAT CRuntimeClass class_name<template_class>::class##class_name##template_class = { \
    #class_name, sizeof(class class_name<template_class>), wSchema, pfnNew, \
    RUNTIME_CLASS01(base_class_name, template_class), NULL, class_init }; \
	template < typename template_class > \
    CRuntimeClass* class_name<template_class>::GetRuntimeClass() const \
    { return RUNTIME_CLASS01(class_name, template_class); }
#define _IMPLEMENT_RUNTIMECLASS01_Base01( class_name, template_class, base_class_name, wSchema, pfnNew, class_init ) \
	template < typename template_class > \
    AFX_COMDAT CRuntimeClass class_name<template_class>::class##class_name##template_class = { \
    #class_name, sizeof(class class_name<template_class>), wSchema, pfnNew, \
    RUNTIME_CLASS01(base_class_name, template_class), NULL, class_init }; \
...
#define DECLARE_DYNCREATE01(class_name, template_class) \
	DECLARE_DYNAMIC01(class_name, template_class) \
	static CObject* PASCAL CreateObject();

#define _DECLARE_DYNCREATE01(class_name, template_class) \
	_DECLARE_DYNAMIC01(class_name, template_class) \
	static CObject* PASCAL CreateObject();

#define DECLARE_SERIAL01(class_name, template_class) \
	_DECLARE_DYNCREATE01(class_name, template_class) \
...
#define IMPLEMENT_DYNCREATE01_Base01( class_name, template_class, base_class_name, base_templateclass ) \
    ...
    CObject* PASCAL class_name<template_class>::CreateObject() \
    { return new class_name<template_class>; } \
    IMPLEMENT_RUNTIMECLASS01_Base01(class_name, template_class, base_class_name, base_templateclass, 0xFFFF, \
    class_name<template_class>::CreateObject, NULL)
...
#define IMPLEMENT_RUNTIMECLASS01(class_name, template_class, base_class_name, wSchema, pfnNew, class_init) \
	...
	template < typename template_class > \
	extern const AFX_COMDAT CRuntimeClass class_name::class##class_name##template_class = { \
		#class_name, sizeof(class class_name<template_class>), wSchema, pfnNew, \
...
#define IMPLEMENT_RUNTIMECLASS01_Base01(class_name, template_class, base_class_name, base_templateclass, wSchema, pfnNew, class_init) \
	...
	template < typename template_class > \
	AFX_COMDAT const CRuntimeClass class_name::class##class_name##template_class = { \
		#class_name, sizeof(class class_name<template_class>), wSchema, pfnNew, \
			&class_name<template_class>::_GetBaseClass, NULL, class_init }; \
	template < typename template_class > \
	CRuntimeClass* PASCAL class_name<template_class>::GetThisClass() \
