...
{
	//struct RegistryObjectTargetData
	//{
	//	typename TargetTypeData;
	//  TargetTypeData* ObjectRegistryObject;
	//};
	struct BasicNode
	{
	...
	//typename ReturnObjectStorageNodeType()
	//{
	//}
	//typename ReturnObjectStorageClassType()
	//{
	//}
};
struct ObjectRegistry
{
	...
	ObjectRegistryClasses::Ni3dsAnimationNode_Storage Ni3dsAnimationNode_Registry;
	ObjectRegistryClasses::Ni3dsColorAnimator_Storage Ni3dsColorAnimator_Registry;
	ObjectRegistryClasses::Ni3dsMorphShape_Storage Ni3dsMorphShape_Registry;
	ObjectRegistryClasses::Ni3dsParticleSystem_Storage Ni3dsParticleSystem_Registry;
	ObjectRegistryClasses::Ni3dsPathController_Storage Ni3dsPathController_Registry;
	ObjectRegistryClasses::NiParticleModifier_Storage NiParticleModifier_Registry;
	ObjectRegistryClasses::NiPSysCollider_Storage NiPSysCollider_Registry;
	ObjectRegistryClasses::bhkRefObject_Storage bhkRefObject_Registry;
	ObjectRegistryClasses::bhkSerializable_Storage bhkSerializable_Registry;
	ObjectRegistryClasses::bhkWorldObject_Storage bhkWorldObject_Registry;
	ObjectRegistryClasses::bhkPhantom_Storage bhkPhantom_Registry;
	ObjectRegistryClasses::bhkShapePhantom_Storage bhkShapePhantom_Registry;
	ObjectRegistryClasses::bhkSimpleShapePhantom_Storage bhkSimpleShapePhantom_Registry;
	ObjectRegistryClasses::bhkEntity_Storage bhkEntity_Registry;
	ObjectRegistryClasses::bhkRigidBody_Storage bhkRigidBody_Registry;
	ObjectRegistryClasses::bhkRigidBodyT_Storage bhkRigidBodyT_Registry;
	ObjectRegistryClasses::bhkConstraint_Storage bhkConstraint_Registry;
	ObjectRegistryClasses::bhkLimitedHingeConstraint_Storage bhkLimitedHingeConstraint_Registry;
	ObjectRegistryClasses::bhkMalleableConstraint_Storage bhkMalleableConstraint_Registry;
	ObjectRegistryClasses::bhkStiffSpringConstraint_Storage bhkStiffSpringConstraint_Registry;
	ObjectRegistryClasses::bhkRagdollConstraint_Storage bhkRagdollConstraint_Registry;
	ObjectRegistryClasses::bhkPrismaticConstraint_Storage bhkPrismaticConstraint_Registry;
	ObjectRegistryClasses::bhkHingeConstraint_Storage bhkHingeConstraint_Registry;
	ObjectRegistryClasses::bhkBallAndSocketConstraint_Storage bhkBallAndSocketConstraint_Registry;
	ObjectRegistryClasses::bhkBallSocketConstraintChain_Storage bhkBallSocketConstraintChain_Registry;
	ObjectRegistryClasses::bhkShape_Storage bhkShape_Registry;
	ObjectRegistryClasses::bhkTransformShape_Storage bhkTransformShape_Registry;
	ObjectRegistryClasses::bhkSphereRepShape_Storage bhkSphereRepShape_Registry;
	ObjectRegistryClasses::bhkConvexShape_Storage bhkConvexShape_Registry;
	ObjectRegistryClasses::bhkSphereShape_Storage bhkSphereShape_Registry;
	ObjectRegistryClasses::bhkCapsuleShape_Storage bhkCapsuleShape_Registry;
	ObjectRegistryClasses::bhkBoxShape_Storage bhkBoxShape_Registry;
	ObjectRegistryClasses::bhkConvexVerticesShape_Storage bhkConvexVerticesShape_Registry;
	ObjectRegistryClasses::bhkConvexTransformShape_Storage bhkConvexTransformShape_Registry;
	ObjectRegistryClasses::bhkMultiSphereShape_Storage bhkMultiSphereShape_Registry;
	ObjectRegistryClasses::bhkBvTreeShape_Storage bhkBvTreeShape_Registry;
	ObjectRegistryClasses::bhkMoppBvTreeShape_Storage bhkMoppBvTreeShape_Registry;
	ObjectRegistryClasses::bhkShapeCollection_Storage bhkShapeCollection_Registry;
	ObjectRegistryClasses::bhkListShape_Storage bhkListShape_Registry;
	ObjectRegistryClasses::bhkMeshShape_Storage bhkMeshShape_Registry;
	ObjectRegistryClasses::bhkPackedNiTriStripsShape_Storage bhkPackedNiTriStripsShape_Registry;
	ObjectRegistryClasses::bhkNiTriStripsShape_Storage bhkNiTriStripsShape_Registry;
	ObjectRegistryClasses::NiExtraData_Storage NiExtraData_Registry;
	ObjectRegistryClasses::NiInterpolator_Storage NiInterpolator_Registry;
	ObjectRegistryClasses::NiKeyBasedInterpolator_Storage NiKeyBasedInterpolator_Registry;
	ObjectRegistryClasses::NiFloatInterpolator_Storage NiFloatInterpolator_Registry;
	ObjectRegistryClasses::NiTransformInterpolator_Storage NiTransformInterpolator_Registry;
	ObjectRegistryClasses::NiPoint3Interpolator_Storage NiPoint3Interpolator_Registry;
	ObjectRegistryClasses::NiPathInterpolator_Storage NiPathInterpolator_Registry;
	ObjectRegistryClasses::NiBoolInterpolator_Storage NiBoolInterpolator_Registry;
	ObjectRegistryClasses::NiBoolTimelineInterpolator_Storage NiBoolTimelineInterpolator_Registry;
	ObjectRegistryClasses::NiBlendInterpolator_Storage NiBlendInterpolator_Registry;
	ObjectRegistryClasses::NiBSplineInterpolator_Storage NiBSplineInterpolator_Registry;
	ObjectRegistryClasses::NiObjectNET_Storage NiObjectNET_Registry;
	ObjectRegistryClasses::NiCollisionObject_Storage NiCollisionObject_Registry;
	ObjectRegistryClasses::NiCollisionData_Storage NiCollisionData_Registry;
	ObjectRegistryClasses::bhkNiCollisionObject_Storage bhkNiCollisionObject_Registry;
	ObjectRegistryClasses::bhkCollisionObject_Storage bhkCollisionObject_Registry;
	ObjectRegistryClasses::bhkBlendCollisionObject_Storage bhkBlendCollisionObject_Registry;
	ObjectRegistryClasses::bhkPCollisionObject_Storage bhkPCollisionObject_Registry;
	ObjectRegistryClasses::bhkSPCollisionObject_Storage bhkSPCollisionObject_Registry;
	ObjectRegistryClasses::NiAVObject_Storage NiAVObject_Registry;
	ObjectRegistryClasses::NiDynamicEffect_Storage NiDynamicEffect_Registry;
	ObjectRegistryClasses::NiLight_Storage NiLight_Registry;
	ObjectRegistryClasses::NiProperty_Storage NiProperty_Registry;
	ObjectRegistryClasses::NiTransparentProperty_Storage NiTransparentProperty_Registry;
	ObjectRegistryClasses::NiPSysModifier_Storage NiPSysModifier_Registry;
	ObjectRegistryClasses::NiPSysEmitter_Storage NiPSysEmitter_Registry;
	ObjectRegistryClasses::NiPSysVolumeEmitter_Storage NiPSysVolumeEmitter_Registry;
	ObjectRegistryClasses::NiTimeController_Storage NiTimeController_Registry;
	ObjectRegistryClasses::NiInterpController_Storage NiInterpController_Registry;
	ObjectRegistryClasses::NiMultiTargetTransformController_Storage NiMultiTargetTransformController_Registry;
	ObjectRegistryClasses::NiGeomMorpherController_Storage NiGeomMorpherController_Registry;
	ObjectRegistryClasses::NiMorphController_Storage NiMorphController_Registry;
	ObjectRegistryClasses::NiMorpherController_Storage NiMorpherController_Registry;
	ObjectRegistryClasses::NiSingleInterpController_Storage NiSingleInterpController_Registry;
	ObjectRegistryClasses::NiKeyframeController_Storage NiKeyframeController_Registry;
	ObjectRegistryClasses::NiTransformController_Storage NiTransformController_Registry;
	ObjectRegistryClasses::NiPSysModifierCtlr_Storage NiPSysModifierCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterCtlr_Storage NiPSysEmitterCtlr_Registry;
	ObjectRegistryClasses::NiPSysModifierBoolCtlr_Storage NiPSysModifierBoolCtlr_Registry;
	ObjectRegistryClasses::NiPSysModifierActiveCtlr_Storage NiPSysModifierActiveCtlr_Registry;
	ObjectRegistryClasses::NiPSysModifierFloatCtlr_Storage NiPSysModifierFloatCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterDeclinationCtlr_Storage NiPSysEmitterDeclinationCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterDeclinationVarCtlr_Storage NiPSysEmitterDeclinationVarCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterInitialRadiusCtlr_Storage NiPSysEmitterInitialRadiusCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterLifeSpanCtlr_Storage NiPSysEmitterLifeSpanCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterSpeedCtlr_Storage NiPSysEmitterSpeedCtlr_Registry;
	ObjectRegistryClasses::NiPSysGravityStrengthCtlr_Storage NiPSysGravityStrengthCtlr_Registry;
	ObjectRegistryClasses::NiFloatInterpController_Storage NiFloatInterpController_Registry;
	ObjectRegistryClasses::NiFlipController_Storage NiFlipController_Registry;
	ObjectRegistryClasses::NiAlphaController_Storage NiAlphaController_Registry;
	ObjectRegistryClasses::NiTextureTransformController_Storage NiTextureTransformController_Registry;
	ObjectRegistryClasses::NiLightDimmerController_Storage NiLightDimmerController_Registry;
	ObjectRegistryClasses::NiBoolInterpController_Storage NiBoolInterpController_Registry;
	ObjectRegistryClasses::NiVisController_Storage NiVisController_Registry;
	ObjectRegistryClasses::NiPoint3InterpController_Storage NiPoint3InterpController_Registry;
	ObjectRegistryClasses::NiMaterialColorController_Storage NiMaterialColorController_Registry;
	ObjectRegistryClasses::NiLightColorController_Storage NiLightColorController_Registry;
	ObjectRegistryClasses::NiExtraDataController_Storage NiExtraDataController_Registry;
	ObjectRegistryClasses::NiFloatExtraDataController_Storage NiFloatExtraDataController_Registry;
	ObjectRegistryClasses::NiBoneLODController_Storage NiBoneLODController_Registry;
	ObjectRegistryClasses::NiBSBoneLODController_Storage NiBSBoneLODController_Registry;
	ObjectRegistryClasses::NiGeometry_Storage NiGeometry_Registry;
	ObjectRegistryClasses::NiTriBasedGeom_Storage NiTriBasedGeom_Registry;
	ObjectRegistryClasses::NiGeometryData_Storage NiGeometryData_Registry;
	ObjectRegistryClasses::AbstractAdditionalGeometryData_Storage AbstractAdditionalGeometryData_Registry;
	ObjectRegistryClasses::NiTriBasedGeomData_Storage NiTriBasedGeomData_Registry;
	ObjectRegistryClasses::bhkBlendController_Storage bhkBlendController_Registry;
	ObjectRegistryClasses::BSBound_Storage BSBound_Registry;
	ObjectRegistryClasses::BSFurnitureMarker_Storage BSFurnitureMarker_Registry;
	ObjectRegistryClasses::BSParentVelocityModifier_Storage BSParentVelocityModifier_Registry;
	ObjectRegistryClasses::BSPSysArrayEmitter_Storage BSPSysArrayEmitter_Registry;
	ObjectRegistryClasses::BSWindModifier_Storage BSWindModifier_Registry;
	ObjectRegistryClasses::hkPackedNiTriStripsData_Storage hkPackedNiTriStripsData_Registry;
	ObjectRegistryClasses::NiAlphaProperty_Storage NiAlphaProperty_Registry;
	ObjectRegistryClasses::NiAmbientLight_Storage NiAmbientLight_Registry;
	ObjectRegistryClasses::NiParticlesData_Storage NiParticlesData_Registry;
	ObjectRegistryClasses::NiRotatingParticlesData_Storage NiRotatingParticlesData_Registry;
	ObjectRegistryClasses::NiAutoNormalParticlesData_Storage NiAutoNormalParticlesData_Registry;
	ObjectRegistryClasses::NiPSysData_Storage NiPSysData_Registry;
	ObjectRegistryClasses::NiMeshPSysData_Storage NiMeshPSysData_Registry;
	ObjectRegistryClasses::NiBinaryExtraData_Storage NiBinaryExtraData_Registry;
	ObjectRegistryClasses::NiBinaryVoxelExtraData_Storage NiBinaryVoxelExtraData_Registry;
	ObjectRegistryClasses::NiBinaryVoxelData_Storage NiBinaryVoxelData_Registry;
	ObjectRegistryClasses::NiBlendBoolInterpolator_Storage NiBlendBoolInterpolator_Registry;
	ObjectRegistryClasses::NiBlendFloatInterpolator_Storage NiBlendFloatInterpolator_Registry;
	ObjectRegistryClasses::NiBlendPoint3Interpolator_Storage NiBlendPoint3Interpolator_Registry;
	ObjectRegistryClasses::NiBlendTransformInterpolator_Storage NiBlendTransformInterpolator_Registry;
	ObjectRegistryClasses::NiBoolData_Storage NiBoolData_Registry;
	ObjectRegistryClasses::NiBooleanExtraData_Storage NiBooleanExtraData_Registry;
	ObjectRegistryClasses::NiBSplineBasisData_Storage NiBSplineBasisData_Registry;
	ObjectRegistryClasses::NiBSplineFloatInterpolator_Storage NiBSplineFloatInterpolator_Registry;
	ObjectRegistryClasses::NiBSplineCompFloatInterpolator_Storage NiBSplineCompFloatInterpolator_Registry;
	ObjectRegistryClasses::NiBSplinePoint3Interpolator_Storage NiBSplinePoint3Interpolator_Registry;
	ObjectRegistryClasses::NiBSplineCompPoint3Interpolator_Storage NiBSplineCompPoint3Interpolator_Registry;
	ObjectRegistryClasses::NiBSplineTransformInterpolator_Storage NiBSplineTransformInterpolator_Registry;
	ObjectRegistryClasses::NiBSplineCompTransformInterpolator_Storage NiBSplineCompTransformInterpolator_Registry;
	ObjectRegistryClasses::BSRotAccumTransfInterpolator_Storage BSRotAccumTransfInterpolator_Registry;
	ObjectRegistryClasses::NiBSplineData_Storage NiBSplineData_Registry;
	ObjectRegistryClasses::NiCamera_Storage NiCamera_Registry;
	ObjectRegistryClasses::NiColorData_Storage NiColorData_Registry;
	ObjectRegistryClasses::NiColorExtraData_Storage NiColorExtraData_Registry;
	ObjectRegistryClasses::NiControllerManager_Storage NiControllerManager_Registry;
	ObjectRegistryClasses::NiSequence_Storage NiSequence_Registry;
	ObjectRegistryClasses::NiControllerSequence_Storage NiControllerSequence_Registry;
	ObjectRegistryClasses::NiAVObjectPalette_Storage NiAVObjectPalette_Registry;
	ObjectRegistryClasses::NiDefaultAVObjectPalette_Storage NiDefaultAVObjectPalette_Registry;
	ObjectRegistryClasses::NiDirectionalLight_Storage NiDirectionalLight_Registry;
	ObjectRegistryClasses::NiDitherProperty_Storage NiDitherProperty_Registry;
	ObjectRegistryClasses::NiRollController_Storage NiRollController_Registry;
	ObjectRegistryClasses::NiFloatData_Storage NiFloatData_Registry;
	ObjectRegistryClasses::NiFloatExtraData_Storage NiFloatExtraData_Registry;
	ObjectRegistryClasses::NiFloatsExtraData_Storage NiFloatsExtraData_Registry;
	ObjectRegistryClasses::NiFogProperty_Storage NiFogProperty_Registry;
	ObjectRegistryClasses::NiGravity_Storage NiGravity_Registry;
	ObjectRegistryClasses::NiIntegerExtraData_Storage NiIntegerExtraData_Registry;
	ObjectRegistryClasses::BSXFlags_Storage BSXFlags_Registry;
	ObjectRegistryClasses::NiIntegersExtraData_Storage NiIntegersExtraData_Registry;
	ObjectRegistryClasses::BSKeyframeController_Storage BSKeyframeController_Registry;
	ObjectRegistryClasses::NiKeyframeData_Storage NiKeyframeData_Registry;
	ObjectRegistryClasses::NiLookAtController_Storage NiLookAtController_Registry;
	ObjectRegistryClasses::NiLookAtInterpolator_Storage NiLookAtInterpolator_Registry;
	ObjectRegistryClasses::NiMaterialProperty_Storage NiMaterialProperty_Registry;
	ObjectRegistryClasses::NiMorphData_Storage NiMorphData_Registry;
	ObjectRegistryClasses::NiNode_Storage NiNode_Registry;
	ObjectRegistryClasses::NiBone_Storage NiBone_Registry;
	ObjectRegistryClasses::AvoidNode_Storage AvoidNode_Registry;
	ObjectRegistryClasses::FxWidget_Storage FxWidget_Registry;
	ObjectRegistryClasses::FxButton_Storage FxButton_Registry;
	ObjectRegistryClasses::FxRadioButton_Storage FxRadioButton_Registry;
	ObjectRegistryClasses::NiBillboardNode_Storage NiBillboardNode_Registry;
	ObjectRegistryClasses::NiBSAnimationNode_Storage NiBSAnimationNode_Registry;
	ObjectRegistryClasses::NiBSParticleNode_Storage NiBSParticleNode_Registry;
	ObjectRegistryClasses::NiSwitchNode_Storage NiSwitchNode_Registry;
	ObjectRegistryClasses::NiLODNode_Storage NiLODNode_Registry;
	ObjectRegistryClasses::NiPalette_Storage NiPalette_Registry;
	ObjectRegistryClasses::NiParticleBomb_Storage NiParticleBomb_Registry;
	ObjectRegistryClasses::NiParticleColorModifier_Storage NiParticleColorModifier_Registry;
	ObjectRegistryClasses::NiParticleGrowFade_Storage NiParticleGrowFade_Registry;
	ObjectRegistryClasses::NiParticleMeshModifier_Storage NiParticleMeshModifier_Registry;
	ObjectRegistryClasses::NiParticleRotation_Storage NiParticleRotation_Registry;
	ObjectRegistryClasses::NiParticles_Storage NiParticles_Registry;
	ObjectRegistryClasses::NiAutoNormalParticles_Storage NiAutoNormalParticles_Registry;
	ObjectRegistryClasses::NiParticleMeshes_Storage NiParticleMeshes_Registry;
	ObjectRegistryClasses::NiParticleMeshesData_Storage NiParticleMeshesData_Registry;
	ObjectRegistryClasses::NiParticleSystem_Storage NiParticleSystem_Registry;
	ObjectRegistryClasses::NiMeshParticleSystem_Storage NiMeshParticleSystem_Registry;
	ObjectRegistryClasses::NiParticleSystemController_Storage NiParticleSystemController_Registry;
	ObjectRegistryClasses::NiBSPArrayController_Storage NiBSPArrayController_Registry;
	ObjectRegistryClasses::NiPathController_Storage NiPathController_Registry;
	ObjectRegistryClasses::ATextureRenderData_Storage ATextureRenderData_Registry;
	ObjectRegistryClasses::NiPersistentSrcTextureRendererData_Storage NiPersistentSrcTextureRendererData_Registry;
	ObjectRegistryClasses::NiPixelData_Storage NiPixelData_Registry;
	ObjectRegistryClasses::NiPlanarCollider_Storage NiPlanarCollider_Registry;
	ObjectRegistryClasses::NiPointLight_Storage NiPointLight_Registry;
	ObjectRegistryClasses::NiPosData_Storage NiPosData_Registry;
	ObjectRegistryClasses::NiPSysAgeDeathModifier_Storage NiPSysAgeDeathModifier_Registry;
	ObjectRegistryClasses::NiPSysBombModifier_Storage NiPSysBombModifier_Registry;
	ObjectRegistryClasses::NiPSysBoundUpdateModifier_Storage NiPSysBoundUpdateModifier_Registry;
	ObjectRegistryClasses::NiPSysBoxEmitter_Storage NiPSysBoxEmitter_Registry;
	ObjectRegistryClasses::NiPSysColliderManager_Storage NiPSysColliderManager_Registry;
	ObjectRegistryClasses::NiPSysColorModifier_Storage NiPSysColorModifier_Registry;
	ObjectRegistryClasses::NiPSysCylinderEmitter_Storage NiPSysCylinderEmitter_Registry;
	ObjectRegistryClasses::NiPSysDragModifier_Storage NiPSysDragModifier_Registry;
	ObjectRegistryClasses::NiPSysEmitterCtlrData_Storage NiPSysEmitterCtlrData_Registry;
	ObjectRegistryClasses::NiPSysGravityModifier_Storage NiPSysGravityModifier_Registry;
	ObjectRegistryClasses::NiPSysGrowFadeModifier_Storage NiPSysGrowFadeModifier_Registry;
	ObjectRegistryClasses::NiPSysMeshEmitter_Storage NiPSysMeshEmitter_Registry;
	ObjectRegistryClasses::NiPSysMeshUpdateModifier_Storage NiPSysMeshUpdateModifier_Registry;
	ObjectRegistryClasses::BSPSysInheritVelocityModifier_Storage BSPSysInheritVelocityModifier_Registry;
	ObjectRegistryClasses::BSPSysHavokUpdateModifier_Storage BSPSysHavokUpdateModifier_Registry;
	ObjectRegistryClasses::BSPSysRecycleBoundModifier_Storage BSPSysRecycleBoundModifier_Registry;
	ObjectRegistryClasses::BSPSysSubTexModifier_Storage BSPSysSubTexModifier_Registry;
	ObjectRegistryClasses::NiPSysPlanarCollider_Storage NiPSysPlanarCollider_Registry;
	ObjectRegistryClasses::NiPSysSphericalCollider_Storage NiPSysSphericalCollider_Registry;
	ObjectRegistryClasses::NiPSysPositionModifier_Storage NiPSysPositionModifier_Registry;
	ObjectRegistryClasses::NiPSysResetOnLoopCtlr_Storage NiPSysResetOnLoopCtlr_Registry;
	ObjectRegistryClasses::NiPSysRotationModifier_Storage NiPSysRotationModifier_Registry;
	ObjectRegistryClasses::NiPSysSpawnModifier_Storage NiPSysSpawnModifier_Registry;
	ObjectRegistryClasses::NiPSysSphereEmitter_Storage NiPSysSphereEmitter_Registry;
	ObjectRegistryClasses::NiPSysUpdateCtlr_Storage NiPSysUpdateCtlr_Registry;
	ObjectRegistryClasses::NiPSysFieldModifier_Storage NiPSysFieldModifier_Registry;
	ObjectRegistryClasses::NiPSysVortexFieldModifier_Storage NiPSysVortexFieldModifier_Registry;
	ObjectRegistryClasses::NiPSysGravityFieldModifier_Storage NiPSysGravityFieldModifier_Registry;
	ObjectRegistryClasses::NiPSysDragFieldModifier_Storage NiPSysDragFieldModifier_Registry;
	ObjectRegistryClasses::NiPSysTurbulenceFieldModifier_Storage NiPSysTurbulenceFieldModifier_Registry;
	ObjectRegistryClasses::BSPSysLODModifier_Storage BSPSysLODModifier_Registry;
	ObjectRegistryClasses::BSPSysScaleModifier_Storage BSPSysScaleModifier_Registry;
	ObjectRegistryClasses::NiPSysFieldMagnitudeCtlr_Storage NiPSysFieldMagnitudeCtlr_Registry;
	ObjectRegistryClasses::NiPSysFieldAttenuationCtlr_Storage NiPSysFieldAttenuationCtlr_Registry;
	ObjectRegistryClasses::NiPSysFieldMaxDistanceCtlr_Storage NiPSysFieldMaxDistanceCtlr_Registry;
	ObjectRegistryClasses::NiPSysAirFieldAirFrictionCtlr_Storage NiPSysAirFieldAirFrictionCtlr_Registry;
	ObjectRegistryClasses::NiPSysAirFieldInheritVelocityCtlr_Storage NiPSysAirFieldInheritVelocityCtlr_Registry;
	ObjectRegistryClasses::NiPSysAirFieldSpreadCtlr_Storage NiPSysAirFieldSpreadCtlr_Registry;
	ObjectRegistryClasses::NiPSysInitialRotSpeedCtlr_Storage NiPSysInitialRotSpeedCtlr_Registry;
	ObjectRegistryClasses::NiPSysInitialRotSpeedVarCtlr_Storage NiPSysInitialRotSpeedVarCtlr_Registry;
	ObjectRegistryClasses::NiPSysInitialRotAngleCtlr_Storage NiPSysInitialRotAngleCtlr_Registry;
	ObjectRegistryClasses::NiPSysInitialRotAngleVarCtlr_Storage NiPSysInitialRotAngleVarCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterPlanarAngleCtlr_Storage NiPSysEmitterPlanarAngleCtlr_Registry;
	ObjectRegistryClasses::NiPSysEmitterPlanarAngleVarCtlr_Storage NiPSysEmitterPlanarAngleVarCtlr_Registry;
	ObjectRegistryClasses::NiPSysAirFieldModifier_Storage NiPSysAirFieldModifier_Registry;
	ObjectRegistryClasses::NiPSysTrailEmitter_Storage NiPSysTrailEmitter_Registry;
	ObjectRegistryClasses::NiLightIntensityController_Storage NiLightIntensityController_Registry;
	ObjectRegistryClasses::NiPSysRadialFieldModifier_Storage NiPSysRadialFieldModifier_Registry;
	ObjectRegistryClasses::NiLODData_Storage NiLODData_Registry;
	ObjectRegistryClasses::NiRangeLODData_Storage NiRangeLODData_Registry;
	ObjectRegistryClasses::NiScreenLODData_Storage NiScreenLODData_Registry;
	ObjectRegistryClasses::NiRotatingParticles_Storage NiRotatingParticles_Registry;
	ObjectRegistryClasses::NiSequenceStreamHelper_Storage NiSequenceStreamHelper_Registry;
	ObjectRegistryClasses::NiShadeProperty_Storage NiShadeProperty_Registry;
	ObjectRegistryClasses::NiSkinData_Storage NiSkinData_Registry;
	ObjectRegistryClasses::NiSkinInstance_Storage NiSkinInstance_Registry;
	ObjectRegistryClasses::NiTriShapeSkinController_Storage NiTriShapeSkinController_Registry;
	ObjectRegistryClasses::NiClodSkinInstance_Storage NiClodSkinInstance_Registry;
	ObjectRegistryClasses::NiSkinPartition_Storage NiSkinPartition_Registry;
	ObjectRegistryClasses::NiTexture_Storage NiTexture_Registry;
	ObjectRegistryClasses::NiSourceTexture_Storage NiSourceTexture_Registry;
	ObjectRegistryClasses::NiSpecularProperty_Storage NiSpecularProperty_Registry;
	ObjectRegistryClasses::NiSphericalCollider_Storage NiSphericalCollider_Registry;
	ObjectRegistryClasses::NiSpotLight_Storage NiSpotLight_Registry;
	ObjectRegistryClasses::NiStencilProperty_Storage NiStencilProperty_Registry;
	ObjectRegistryClasses::NiStringExtraData_Storage NiStringExtraData_Registry;
	ObjectRegistryClasses::NiStringPalette_Storage NiStringPalette_Registry;
	ObjectRegistryClasses::NiStringsExtraData_Storage NiStringsExtraData_Registry;
	ObjectRegistryClasses::NiTextKeyExtraData_Storage NiTextKeyExtraData_Registry;
	ObjectRegistryClasses::NiTextureEffect_Storage NiTextureEffect_Registry;
	ObjectRegistryClasses::NiTextureModeProperty_Storage NiTextureModeProperty_Registry;
	ObjectRegistryClasses::NiImage_Storage NiImage_Registry;
	ObjectRegistryClasses::NiTextureProperty_Storage NiTextureProperty_Registry;
	ObjectRegistryClasses::NiMultiTextureProperty_Storage NiMultiTextureProperty_Registry;
	ObjectRegistryClasses::NiTexturingProperty_Storage NiTexturingProperty_Registry;
	ObjectRegistryClasses::NiTransformData_Storage NiTransformData_Registry;
	ObjectRegistryClasses::NiTriShape_Storage NiTriShape_Registry;
	ObjectRegistryClasses::NiTriShapeData_Storage NiTriShapeData_Registry;
	ObjectRegistryClasses::NiTriStrips_Storage NiTriStrips_Registry;
	ObjectRegistryClasses::NiTriStripsData_Storage NiTriStripsData_Registry;
	ObjectRegistryClasses::NiEnvMappedTriShape_Storage NiEnvMappedTriShape_Registry;
	ObjectRegistryClasses::NiEnvMappedTriShapeData_Storage NiEnvMappedTriShapeData_Registry;
	ObjectRegistryClasses::NiBezierTriangle4_Storage NiBezierTriangle4_Registry;
	ObjectRegistryClasses::NiBezierMesh_Storage NiBezierMesh_Registry;
	ObjectRegistryClasses::NiClod_Storage NiClod_Registry;
	ObjectRegistryClasses::NiClodData_Storage NiClodData_Registry;
	ObjectRegistryClasses::NiUVController_Storage NiUVController_Registry;
	ObjectRegistryClasses::NiUVData_Storage NiUVData_Registry;
	ObjectRegistryClasses::NiVectorExtraData_Storage NiVectorExtraData_Registry;
	ObjectRegistryClasses::NiVertexColorProperty_Storage NiVertexColorProperty_Registry;
	ObjectRegistryClasses::NiVertWeightsExtraData_Storage NiVertWeightsExtraData_Registry;
	ObjectRegistryClasses::NiVisData_Storage NiVisData_Registry;
	ObjectRegistryClasses::NiWireframeProperty_Storage NiWireframeProperty_Registry;
	ObjectRegistryClasses::NiZBufferProperty_Storage NiZBufferProperty_Registry;
	ObjectRegistryClasses::RootCollisionNode_Storage RootCollisionNode_Registry;
	ObjectRegistryClasses::NiRawImageData_Storage NiRawImageData_Registry;
	ObjectRegistryClasses::NiSortAdjustNode_Storage NiSortAdjustNode_Registry;
	ObjectRegistryClasses::NiSourceCubeMap_Storage NiSourceCubeMap_Registry;
	ObjectRegistryClasses::NiPhysXProp_Storage NiPhysXProp_Registry;
	ObjectRegistryClasses::NiPhysXPropDesc_Storage NiPhysXPropDesc_Registry;
	ObjectRegistryClasses::NiPhysXActorDesc_Storage NiPhysXActorDesc_Registry;
	ObjectRegistryClasses::NiPhysXBodyDesc_Storage NiPhysXBodyDesc_Registry;
	ObjectRegistryClasses::NiPhysXD6JointDesc_Storage NiPhysXD6JointDesc_Registry;
	ObjectRegistryClasses::NiPhysXShapeDesc_Storage NiPhysXShapeDesc_Registry;
	ObjectRegistryClasses::NiPhysXMeshDesc_Storage NiPhysXMeshDesc_Registry;
	ObjectRegistryClasses::NiPhysXMaterialDesc_Storage NiPhysXMaterialDesc_Registry;
	ObjectRegistryClasses::NiPhysXKinematicSrc_Storage NiPhysXKinematicSrc_Registry;
	ObjectRegistryClasses::NiPhysXTransformDest_Storage NiPhysXTransformDest_Registry;
	ObjectRegistryClasses::NiArkAnimationExtraData_Storage NiArkAnimationExtraData_Registry;
	ObjectRegistryClasses::NiArkImporterExtraData_Storage NiArkImporterExtraData_Registry;
	ObjectRegistryClasses::NiArkTextureExtraData_Storage NiArkTextureExtraData_Registry;
	ObjectRegistryClasses::NiArkViewportInfoExtraData_Storage NiArkViewportInfoExtraData_Registry;
	ObjectRegistryClasses::NiArkShaderExtraData_Storage NiArkShaderExtraData_Registry;
	ObjectRegistryClasses::NiLines_Storage NiLines_Registry;
	ObjectRegistryClasses::NiLinesData_Storage NiLinesData_Registry;
	ObjectRegistryClasses::NiScreenElementsData_Storage NiScreenElementsData_Registry;
	ObjectRegistryClasses::NiScreenElements_Storage NiScreenElements_Registry;
	ObjectRegistryClasses::NiRoomGroup_Storage NiRoomGroup_Registry;
	ObjectRegistryClasses::NiRoom_Storage NiRoom_Registry;
	ObjectRegistryClasses::NiPortal_Storage NiPortal_Registry;
	ObjectRegistryClasses::BSFadeNode_Storage BSFadeNode_Registry;
	ObjectRegistryClasses::BSShaderProperty_Storage BSShaderProperty_Registry;
	ObjectRegistryClasses::BSShaderLightingProperty_Storage BSShaderLightingProperty_Registry;
	ObjectRegistryClasses::BSShaderNoLightingProperty_Storage BSShaderNoLightingProperty_Registry;
	ObjectRegistryClasses::BSShaderPPLightingProperty_Storage BSShaderPPLightingProperty_Registry;
	ObjectRegistryClasses::BSEffectShaderPropertyFloatController_Storage BSEffectShaderPropertyFloatController_Registry;
	ObjectRegistryClasses::BSEffectShaderPropertyColorController_Storage BSEffectShaderPropertyColorController_Registry;
	ObjectRegistryClasses::BSLightingShaderPropertyFloatController_Storage BSLightingShaderPropertyFloatController_Registry;
	ObjectRegistryClasses::BSLightingShaderPropertyColorController_Storage BSLightingShaderPropertyColorController_Registry;
	ObjectRegistryClasses::BSNiAlphaPropertyTestRefController_Storage BSNiAlphaPropertyTestRefController_Registry;
	ObjectRegistryClasses::BSProceduralLightningController_Storage BSProceduralLightningController_Registry;
	ObjectRegistryClasses::BSShaderTextureSet_Storage BSShaderTextureSet_Registry;
	ObjectRegistryClasses::WaterShaderProperty_Storage WaterShaderProperty_Registry;
	ObjectRegistryClasses::SkyShaderProperty_Storage SkyShaderProperty_Registry;
	ObjectRegistryClasses::TileShaderProperty_Storage TileShaderProperty_Registry;
	ObjectRegistryClasses::DistantLODShaderProperty_Storage DistantLODShaderProperty_Registry;
	ObjectRegistryClasses::BSDistantTreeShaderProperty_Storage BSDistantTreeShaderProperty_Registry;
	ObjectRegistryClasses::TallGrassShaderProperty_Storage TallGrassShaderProperty_Registry;
	ObjectRegistryClasses::VolumetricFogShaderProperty_Storage VolumetricFogShaderProperty_Registry;
	ObjectRegistryClasses::HairShaderProperty_Storage HairShaderProperty_Registry;
	ObjectRegistryClasses::Lighting30ShaderProperty_Storage Lighting30ShaderProperty_Registry;
	ObjectRegistryClasses::BSLightingShaderProperty_Storage BSLightingShaderProperty_Registry;
	ObjectRegistryClasses::BSEffectShaderProperty_Storage BSEffectShaderProperty_Registry;
	ObjectRegistryClasses::BSWaterShaderProperty_Storage BSWaterShaderProperty_Registry;
	ObjectRegistryClasses::BSSkyShaderProperty_Storage BSSkyShaderProperty_Registry;
	ObjectRegistryClasses::BSDismemberSkinInstance_Storage BSDismemberSkinInstance_Registry;
	ObjectRegistryClasses::BSDecalPlacementVectorExtraData_Storage BSDecalPlacementVectorExtraData_Registry;
	ObjectRegistryClasses::BSPSysSimpleColorModifier_Storage BSPSysSimpleColorModifier_Registry;
	ObjectRegistryClasses::BSValueNode_Storage BSValueNode_Registry;
	ObjectRegistryClasses::BSStripParticleSystem_Storage BSStripParticleSystem_Registry;
	ObjectRegistryClasses::BSStripPSysData_Storage BSStripPSysData_Registry;
	ObjectRegistryClasses::BSPSysStripUpdateModifier_Storage BSPSysStripUpdateModifier_Registry;
	ObjectRegistryClasses::BSMaterialEmittanceMultController_Storage BSMaterialEmittanceMultController_Registry;
	ObjectRegistryClasses::BSMasterParticleSystem_Storage BSMasterParticleSystem_Registry;
	ObjectRegistryClasses::BSPSysMultiTargetEmitterCtlr_Storage BSPSysMultiTargetEmitterCtlr_Registry;
	ObjectRegistryClasses::BSRefractionStrengthController_Storage BSRefractionStrengthController_Registry;
	ObjectRegistryClasses::BSOrderedNode_Storage BSOrderedNode_Registry;
	ObjectRegistryClasses::BSBlastNode_Storage BSBlastNode_Registry;
	ObjectRegistryClasses::BSDamageStage_Storage BSDamageStage_Registry;
	ObjectRegistryClasses::BSRefractionFirePeriodController_Storage BSRefractionFirePeriodController_Registry;
	ObjectRegistryClasses::bhkConvexListShape_Storage bhkConvexListShape_Registry;
	ObjectRegistryClasses::BSTreadTransfInterpolator_Storage BSTreadTransfInterpolator_Registry;
	ObjectRegistryClasses::BSAnimNotes_Storage BSAnimNotes_Registry;
	ObjectRegistryClasses::bhkLiquidAction_Storage bhkLiquidAction_Registry;
	ObjectRegistryClasses::BSMultiBoundNode_Storage BSMultiBoundNode_Registry;
	ObjectRegistryClasses::BSMultiBound_Storage BSMultiBound_Registry;
	ObjectRegistryClasses::BSMultiBoundData_Storage BSMultiBoundData_Registry;
	ObjectRegistryClasses::BSMultiBoundOBB_Storage BSMultiBoundOBB_Registry;
	ObjectRegistryClasses::BSMultiBoundSphere_Storage BSMultiBoundSphere_Registry;
	ObjectRegistryClasses::BSSegmentedTriShape_Storage BSSegmentedTriShape_Registry;
	ObjectRegistryClasses::BSMultiBoundAABB_Storage BSMultiBoundAABB_Registry;
	ObjectRegistryClasses::NiAdditionalGeometryData_Storage NiAdditionalGeometryData_Registry;
	ObjectRegistryClasses::BSPackedAdditionalGeometryData_Storage BSPackedAdditionalGeometryData_Registry;
	ObjectRegistryClasses::BSWArray_Storage BSWArray_Registry;
	ObjectRegistryClasses::bhkAabbPhantom_Storage bhkAabbPhantom_Registry;
	ObjectRegistryClasses::BSFrustumFOVController_Storage BSFrustumFOVController_Registry;
	ObjectRegistryClasses::BSDebrisNode_Storage BSDebrisNode_Registry;
	ObjectRegistryClasses::bhkBreakableConstraint_Storage bhkBreakableConstraint_Registry;
	ObjectRegistryClasses::bhkOrientHingedBodyAction_Storage bhkOrientHingedBodyAction_Registry;
	ObjectRegistryClasses::NiDataStream_Storage NiDataStream_Registry;
	ObjectRegistryClasses::NiRenderObject_Storage NiRenderObject_Registry;
	ObjectRegistryClasses::NiMeshModifier_Storage NiMeshModifier_Registry;
	ObjectRegistryClasses::NiMesh_Storage NiMesh_Registry;
	ObjectRegistryClasses::NiMorphWeightsController_Storage NiMorphWeightsController_Registry;
	ObjectRegistryClasses::NiMorphMeshModifier_Storage NiMorphMeshModifier_Registry;
	ObjectRegistryClasses::NiSkinningMeshModifier_Storage NiSkinningMeshModifier_Registry;
	ObjectRegistryClasses::NiInstancingMeshModifier_Storage NiInstancingMeshModifier_Registry;
	ObjectRegistryClasses::NiSkinningLODController_Storage NiSkinningLODController_Registry;
	ObjectRegistryClasses::NiPSParticleSystem_Storage NiPSParticleSystem_Registry;
	ObjectRegistryClasses::NiPSMeshParticleSystem_Storage NiPSMeshParticleSystem_Registry;
	ObjectRegistryClasses::NiPSEmitParticlesCtlr_Storage NiPSEmitParticlesCtlr_Registry;
	ObjectRegistryClasses::NiPSForceActiveCtlr_Storage NiPSForceActiveCtlr_Registry;
	ObjectRegistryClasses::NiPSSimulator_Storage NiPSSimulator_Registry;
	ObjectRegistryClasses::NiPSSimulatorStep_Storage NiPSSimulatorStep_Registry;
	ObjectRegistryClasses::NiPSSimulatorGeneralStep_Storage NiPSSimulatorGeneralStep_Registry;
	ObjectRegistryClasses::NiPSSimulatorForcesStep_Storage NiPSSimulatorForcesStep_Registry;
	ObjectRegistryClasses::NiPSSimulatorCollidersStep_Storage NiPSSimulatorCollidersStep_Registry;
	ObjectRegistryClasses::NiPSSimulatorMeshAlignStep_Storage NiPSSimulatorMeshAlignStep_Registry;
	ObjectRegistryClasses::NiPSSimulatorFinalStep_Storage NiPSSimulatorFinalStep_Registry;
	ObjectRegistryClasses::NiPSFacingQuadGenerator_Storage NiPSFacingQuadGenerator_Registry;
	ObjectRegistryClasses::NiShadowGenerator_Storage NiShadowGenerator_Registry;
	ObjectRegistryClasses::NiPSBoundUpdater_Storage NiPSBoundUpdater_Registry;
	ObjectRegistryClasses::NiPSDragForce_Storage NiPSDragForce_Registry;
	ObjectRegistryClasses::NiPSGravityForce_Storage NiPSGravityForce_Registry;
	ObjectRegistryClasses::NiPSBoxEmitter_Storage NiPSBoxEmitter_Registry;
	ObjectRegistryClasses::NiPSMeshEmitter_Storage NiPSMeshEmitter_Registry;
	ObjectRegistryClasses::NiPSGravityStrengthCtlr_Storage NiPSGravityStrengthCtlr_Registry;
	ObjectRegistryClasses::NiPSPlanarCollider_Storage NiPSPlanarCollider_Registry;
	ObjectRegistryClasses::NiPSEmitterSpeedCtlr_Storage NiPSEmitterSpeedCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterRadiusCtlr_Storage NiPSEmitterRadiusCtlr_Registry;
	ObjectRegistryClasses::NiPSResetOnLoopCtlr_Storage NiPSResetOnLoopCtlr_Registry;
	ObjectRegistryClasses::NiPSSphereEmitter_Storage NiPSSphereEmitter_Registry;
	ObjectRegistryClasses::NiPSCylinderEmitter_Storage NiPSCylinderEmitter_Registry;
	ObjectRegistryClasses::NiPSEmitterDeclinationCtlr_Storage NiPSEmitterDeclinationCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterDeclinationVarCtlr_Storage NiPSEmitterDeclinationVarCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterPlanarAngleCtlr_Storage NiPSEmitterPlanarAngleCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterPlanarAngleVarCtlr_Storage NiPSEmitterPlanarAngleVarCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterRotAngleCtlr_Storage NiPSEmitterRotAngleCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterRotAngleVarCtlr_Storage NiPSEmitterRotAngleVarCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterRotSpeedCtlr_Storage NiPSEmitterRotSpeedCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterRotSpeedVarCtlr_Storage NiPSEmitterRotSpeedVarCtlr_Registry;
	ObjectRegistryClasses::NiPSEmitterLifeSpanCtlr_Storage NiPSEmitterLifeSpanCtlr_Registry;
	ObjectRegistryClasses::NiPSBombForce_Storage NiPSBombForce_Registry;
	ObjectRegistryClasses::NiPSSphericalCollider_Storage NiPSSphericalCollider_Registry;
	ObjectRegistryClasses::NiPSSpawner_Storage NiPSSpawner_Registry;
	ObjectRegistryClasses::NiSequenceData_Storage NiSequenceData_Registry;
	ObjectRegistryClasses::NiTransformEvaluator_Storage NiTransformEvaluator_Registry;
	ObjectRegistryClasses::NiBSplineCompTransformEvaluator_Storage NiBSplineCompTransformEvaluator_Registry;
	ObjectRegistryClasses::NiMeshHWInstance_Storage NiMeshHWInstance_Registry;
	ObjectRegistryClasses::NiFurSpringController_Storage NiFurSpringController_Registry;
	ObjectRegistryClasses::CStreamableAssetData_Storage CStreamableAssetData_Registry;
	ObjectRegistryClasses::bhkCompressedMeshShape_Storage bhkCompressedMeshShape_Registry;
	ObjectRegistryClasses::bhkCompressedMeshShapeData_Storage bhkCompressedMeshShapeData_Registry;
	ObjectRegistryClasses::BSInvMarker_Storage BSInvMarker_Registry;
	ObjectRegistryClasses::BSBoneLODExtraData_Storage BSBoneLODExtraData_Registry;
	ObjectRegistryClasses::BSBehaviorGraphExtraData_Storage BSBehaviorGraphExtraData_Registry;
	ObjectRegistryClasses::BSLagBoneController_Storage BSLagBoneController_Registry;
	ObjectRegistryClasses::BSLODTriShape_Storage BSLODTriShape_Registry;
	ObjectRegistryClasses::BSFurnitureMarkerNode_Storage BSFurnitureMarkerNode_Registry;
	ObjectRegistryClasses::BSLeafAnimNode_Storage BSLeafAnimNode_Registry;
	ObjectRegistryClasses::BSTreeNode_Storage BSTreeNode_Registry;
	ObjectRegistryClasses::NiLightRadiusController_Storage NiLightRadiusController_Registry;
	ObjectRegistryClasses::BSShape_Storage BSShape_Registry;
	ObjectRegistryClasses::BSTriShape_Storage BSTriShape_Registry;
	ObjectRegistryClasses::BSSubIndexTriShape_Storage BSSubIndexTriShape_Registry;
	ObjectRegistryClasses::BSMeshLODTriShape_Storage BSMeshLODTriShape_Registry;
	ObjectRegistryClasses::bhkNPCollisionObject_Storage bhkNPCollisionObject_Registry;
	ObjectRegistryClasses::BSExtraData_Storage BSExtraData_Registry;
	ObjectRegistryClasses::bhkPhysicsSystem_Storage bhkPhysicsSystem_Registry;
	ObjectRegistryClasses::bhkRagdollSystem_Storage bhkRagdollSystem_Registry;
	ObjectRegistryClasses::BSClothExtraData_Storage BSClothExtraData_Registry;
	ObjectRegistryClasses::BSSkin__Instance_Storage BSSkin__Instance_Registry;
	ObjectRegistryClasses::BSSkin__BoneData_Storage BSSkin__BoneData_Registry;
	ObjectRegistryClasses::BSPositionData_Storage BSPositionData_Registry;
