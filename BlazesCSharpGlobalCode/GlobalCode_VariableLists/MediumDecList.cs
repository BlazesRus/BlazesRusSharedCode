...
namespace CSharpGlobalCode.GlobalCode_VariableLists
{
	/// <summary>
	/// Class MediumDecList.
	/// Implements the <see cref="System.Collections.Generic.List{CSharpGlobalCode.GlobalCode_ExperimentalCode.MediumDec}" />
	/// </summary>
	/// <seealso cref="System.Collections.Generic.List{CSharpGlobalCode.GlobalCode_ExperimentalCode.MediumDec}" />
