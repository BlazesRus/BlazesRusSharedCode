...
namespace CSharpGlobalCode.Databases
{
	/// <summary>
	...
	/// <summary>
	/// Class IniData.
	/// Implements the <see cref="System.Collections.Generic.List{CSharpGlobalCode.Databases.IniDataElement}" />
	/// </summary>
	/// <seealso cref="System.Collections.Generic.List{CSharpGlobalCode.Databases.IniDataElement}" />
