...
#pragma warning disable CS3021 // Type or member does not need a CLSCompliant attribute because the assembly does not have a CLSCompliant attribute
    ...
    //#if (BlazesGlobalCode_SmallDecV2_AsStruct)
    ...
    ////#if (BlazesGlobalCode_StandardExplicitConversionFrom)//Gets confused since it tries auto converting to SmallDecV2 inside parameter first
    ...
    //            SmallDecV2 NewSelf;
    //            NewSelf.IntValue = 0; 
    //#if (BlazesGlobalCode_SmallDecV2_EnableSpecialDecStates)
