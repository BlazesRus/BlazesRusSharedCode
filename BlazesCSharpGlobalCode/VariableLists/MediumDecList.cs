...
namespace CSharpGlobalCode.VariableLists
{
	/// <summary>
	/// Class MediumDecList.
	/// Implements the <see cref="System.Collections.Generic.List{CSharpGlobalCode.ExperimentalCode.MediumDec}" />
	/// </summary>
	/// <seealso cref="System.Collections.Generic.List{CSharpGlobalCode.ExperimentalCode.MediumDec}" />
