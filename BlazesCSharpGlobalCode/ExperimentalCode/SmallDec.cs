    ...
    SmallDec : IFormattable, INotifyPropertyChanged, IComparable<SmallDec>, IConvertible, IEquatable<SmallDec>
    {
        ...
        public SmallDec(dynamic Value)
        {
            ...
            else
            {
                ...
                if (ValueTypeName == "CSharpGlobalCode.ExperimentalCode.SmallDec" || ValueType == typeof(SmallDec))
                {
#if (SmallDec_ReducedSize || SmallDec_UseLegacyStorage)
                this.DecBoolStatus = Value.DecBoolStatus;
#endif
...
#pragma warning restore EA002 // Swallow exceptions considered harmful
        ...
        public override bool Equals(object value)
        {
            ...
            try
            {
                ...
                if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.SmallDec")//SmallDec to SmallDec Comparison
                {
        ...
        public int CompareTo(object value)
        {
            ...
            switch (FullValueTypeName)
            {
                ...
                default:
                    {
                        if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.SmallDec")//SmallDec comparisons
                        {
...
#endif
            //else if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.SmallDec")//SmallDec conversion
            //{
