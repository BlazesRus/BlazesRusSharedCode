    ...
    MediumDec : IFormattable, INotifyPropertyChanged, IComparable<MediumDec>, IConvertible, IEquatable<MediumDec>
    {
        ...
        public MediumDec(dynamic Value)
        {
            ...
            else
            {
                ...
                if (ValueTypeName == "CSharpGlobalCode.ExperimentalCode.MediumDec" || ValueType == typeof(MediumDec))
                {
...
#pragma warning restore EA002 // Swallow exceptions considered harmful
        ...
        public override bool Equals(object value)
        {
            ...
            try
            {
                ...
                if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.MediumDec")//MediumDec to MediumDec Comparison
                {
        ...
        public int CompareTo(object value)
        {
            ...
            switch (FullValueTypeName)
            {
                ...
                default:
                    {
                        if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.MediumDec")//MediumDec comparisons
                        {
...
#endif
            //else if (FullValueTypeName == "CSharpGlobalCode.ExperimentalCode.MediumDec")//MediumDec conversion
            //{
