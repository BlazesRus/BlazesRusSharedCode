...
#pragma warning disable CS0436 // Type conflicts with imported type
            ...
            if (y is double || y is float || y is decimal)
            {
                ...
                if (self.DecBoolStatus != 0 || y != 0)
                {
                    ...
                    if (self.DecBoolStatus == 1 && IsYNegative == false)
                    {
                        ...
                        try
                        {
                            ulong DecimalStatusTemp = self.DecimalStatus + SecondDec;
        ...
        /// <returns></returns>
        public static bool operator ==(ModerateSuperDec self, ModerateSuperDec Value) => self.DecBoolStatus == Value.DecBoolStatus && self.IntValue == Value.IntValue && self.DecimalStatus == Value.DecimalStatus;
