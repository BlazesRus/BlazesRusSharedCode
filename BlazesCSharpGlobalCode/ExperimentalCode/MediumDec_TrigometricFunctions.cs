...
namespace CSharpGlobalCode.ExperimentalCode
{
    ...
    MediumDec : IFormattable, INotifyPropertyChanged
    {
        ...
        public static MediumDec SinFromAngle(MediumDec Value)
        {
            ...
            else
            {
                ...
                { // That's Taylor series!!
                    NewValue += (i%2 == 0 ? 1 : -1) * Pow(Radius, 2 * i + 1) / SuperDecGlobalCode.Fact(2 * i + 1);
                }
                return NewValue;
        ...
        public static MediumDec CosFromAngle(MediumDec Value)
        {
            ...
            else
            {
                ...
                { // That's also Taylor series!!
                    NewValue += (i % 2 == 0 ? 1 : -1) * Pow(Radius, 2 * i) / SuperDecGlobalCode.Fact(2 * i);
                }
                return NewValue;
            }
        }
        ...
        public static MediumDec Tan(MediumDec Value)
        {
            ...
            for (int i = 0; i < 7; ++i)
            {
                SinValue += (i%2 == 0 ? 1 : -1) * Pow(Value, 2 * i + 1) / SuperDecGlobalCode.Fact(2 * i + 1);
            }
            for (int i = 0; i < 7; ++i)
            {
                CosValue += (i%2 == 0 ? 1 : -1) * Pow(Value, 2 * i) / SuperDecGlobalCode.Fact(2 * i);
            }
